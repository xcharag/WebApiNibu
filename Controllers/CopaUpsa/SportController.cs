...
{
    [HttpGet]
    public async Task<IActionResult> GetAll([FromQuery] SportFilter filter, [FromQuery] PaginationParams pagination, CancellationToken ct)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] SportCreateDto dto, CancellationToken ct)
    {
