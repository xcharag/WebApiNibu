...
public class ParticipationController(IParticipation service) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> GetAll([FromQuery] ParticipationFilter filter, [FromQuery] PaginationParams pagination, CancellationToken ct)
    {
