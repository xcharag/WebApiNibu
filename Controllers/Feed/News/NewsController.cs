...
public class NewsController(INews service) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> GetAll(
        [FromQuery] NewsFilter filter,
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] NewsCreateDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] NewsUpdateDto dto, CancellationToken ct)
    {
