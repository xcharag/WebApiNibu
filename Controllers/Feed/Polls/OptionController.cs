...
public class OptionController(IOption service) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> GetAll(
        [FromQuery] OptionFilter filter,
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] OptionCreateDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] OptionUpdateDto dto, CancellationToken ct)
    {
