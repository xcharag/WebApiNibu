...
public class AdultTypeController(IAdultType service) : ControllerBase
{
    // GET: api/AdultType
    [HttpGet]
    ...
    // GET: api/AdultType/filter
    [HttpGet("filter")]
    public async Task<IActionResult> GetFiltered([FromQuery] AdultTypeFilter filter, CancellationToken ct)
    {
    ...
    // POST: api/AdultType
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AdultTypeCreateDto dto, CancellationToken ct)
    {
