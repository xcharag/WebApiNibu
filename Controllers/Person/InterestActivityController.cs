...
public class InterestActivityController : ControllerBase
{
    private readonly IBaseCrud<InterestActivity> _service;

    public InterestActivityController(IBaseCrud<InterestActivity> service)
    {
        _service = service;
    }
