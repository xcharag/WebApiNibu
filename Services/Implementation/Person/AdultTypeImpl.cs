...
public class AdultTypeImpl(IBaseCrud<Data.Entity.Person.AdultType> baseCrud, OracleDbContext db)
    : IAdultType
{
    private readonly AdultTypeQueries _queries = new(db);
    private readonly AdultTypeCommands _commands = new(baseCrud);
